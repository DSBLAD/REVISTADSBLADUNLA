const tipoA = [
  {
    ...
    tipo: "A",
    rutaImg: "01_andrade-seucoo",
    rutaPdf: "andrade-proyecto_seucoo",
  },
  {
    autor: "andrade, guillermo",
    ...
    tipo: "A",
    rutaImg: "02_andrade-polo",
    rutaPdf: "andrade-polo_tecnologico",
  },
  {
    ...
    subtitulo: "",
    tipo: "A",
    rutaImg: "05_corvalan-salamone",
    rutaPdf: "corvalan-firmas_salamone",
  },
  {
    autor: "covas, sheila",
    ...
    tipo: "A",
    rutaImg: "06_covas-neuroconvivir",
    rutaPdf: "covas-disenar_neuroconvivir",
  },
  {
    ...
    tipo: "A",
    rutaImg: "08_dorado-sustentabilidad",
    rutaPdf: "dorado-innovacion_sustentabilidad",
  },
  {
    ...
    tipo: "A",
    rutaImg: "09_fondevilla-etica",
    rutaPdf: "fondevila-ia_etica",
  },
  {
    ...
    tipo: "A",
    rutaImg: "11_gergich-patrimonio",
    rutaPdf: "gergich-patrimonio_cultura",
  },
  {
    ...
    subtitulo: "",
    tipo: "A",
    rutaImg: "14_suarez-oficio",
    rutaPdf: "suarez-oficio_disenadores",
  },
  {
    autor: "tapia, clara",
    titulo:
    ...
    subtitulo: "",
    tipo: "A",
    rutaImg: "15_tapia-cooperativa",
    rutaPdf: "tapia-cooperativa",
  },
  {
    ...
    tipo: "A",
    rutaImg: "18_weissel-salamone",
    rutaPdf: "weissel-grito_urbano",
  },
  {
    autor: "dorado & gergich",
    titulo: "Cinco años del Laboratorio de Diseño de la UNLa",
    subtitulo:
      "Orígenes, ideas fundantes y proyectos clave de sus primeros cinco años",
    tipo: "A",
    rutaImg: "24_dorado-gergich_lad",
    rutaPdf: "dorado-gergich_lad",
  },
];
...
const tipoB = [
  {
    ...
    tipo: "B",
    rutaImg: "07_damico-poetica",
    rutaPdf: "damico-diseno_poetica",
  },
];
...
const tipoC = [
  {
    ...
    tipo: "C",
    rutaImg: "03_caffaro-circular",
    rutaPdf: "caffaro-rediseniar_circular",
  },
  {
    ...
    tipo: "C",
    rutaImg: "04_carpintero-ia",
    rutaPdf: "carpintero-revolucion_ia",
  },
  {
    autor: "fondevila, estefanía",
    ...
    tipo: "C",
    rutaImg: "10_fondevilla-semillero",
    rutaPdf: "fondevila-universidades_semillero",
  },
  {
    ...
    subtitulo: "",
    tipo: "C",
    rutaImg: "12_osorio-paneles",
    rutaPdf: "ossorio-paneles_integradores",
  },
  {
    ...
    subtitulo: "",
    tipo: "C",
    rutaImg: "13_ruscitti-industria",
    rutaPdf: "ruscitti-herramientas_industria",
  },
  {
    autor: "velazco, diego",
    ...
    tipo: "C",
    rutaImg: "17_velazco-ia",
    rutaPdf: "velazco-ia_taller",
  },
  {
    autor: "moreira, leo",
    titulo: "La maratón",
    ...
    tipo: "C",
    rutaImg: "19_moreira-maraton",
    rutaPdf: "moreira-la_maraton",
  },
  {
    autor: "faye, juan",
    titulo: "CHAMP",
  ...
  },
  {
    ...
    rutaPdf: "junco-thomas_experiencias",
  },
  {
  ...
  },
  {
    ...
    tipo: "C",
    rutaImg: "16_tapia-metodos",
    rutaPdf: "tapia-diagnostico",
  },
];
...
const tipoD = [
  {
    ...
    subtitulo: "",
    tipo: "D",
    rutaImg: "21_bozzani-editorial",
    rutaPdf: "bozzani-editorial",
  },
  {
    autor: "recalde, aritz",
    titulo: "Editorial",
    subtitulo: "",
    tipo: "D",
    rutaImg: "26_recalde_editorial",
    rutaPdf: "recalde-editorial",
  },
  // {
  //   autor: "",
  //   titulo: "Dossier",
  //   subtitulo: "5 años del LAD: Presentación de proyectos",
  //   tipo: "D",
  //   rutaImg: "dossier",
  //   rutaPdf: "dossier-5_aniversario_LAD",
  // },
  // {
  //   autor: "",
  //   titulo: "Infografía",
  //   subtitulo: "5 años del LAD: Visualización de proyectos",
  //   tipo: "D",
  //   rutaImg: "infografia",
  //   rutaPdf: "infografia-5_aniversario_LAD",
  // },
];
...
function renderPublicaciones({
  data = [],
  contenedorId,
  carpetaDocs = "./documents/n01/desagregado/DSBLAD01-2025_",
  ...
  data.forEach((item) => {
    ...
    const enlaceDescarga = item?.rutaPdf
      ? `${carpetaDocs}${item.rutaPdf}.pdf`
      : "";
    ...
    imagen.src = `${carpetaImgs}${item.rutaImg}.png`;
    imagen.alt = titulo;
    imagen.onerror = () => {
