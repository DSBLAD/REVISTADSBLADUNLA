...
const miembrosConsejoRedaccion = [
  {
...
const miembrosComiteCientifico = [
  {
...
const miembrosDiseno = [
  {
    nombre: "Esp. DG Angelina Sanchez",
    cargo: "Dirección de Diseño Editorial",
    bio: "Angelina Sánchez es diseñadora gráfica y especialista en diseño de tipografías (FADU-UBA). Desde 2005 dicta clases en la Universidad Nacional de Lanús (UNLa) en materias vinculadas al diseño editorial y uso tipográfico. Trabaja en forma independiente en proyectos de identidad visual, difusión y diseño editorial asociados al ámbito de la cultura y la música independiente. Participó en proyectos colaborativos en diseño, investigación y difusión como «Soytutype» fundidiora tipográfica; «AEZpress» letterpress; «Epígrafes porteños» tipografía en fachadas de Bs. As.; «Etnotipografías» proyecto de diseño en UNLa.; «Birras y letras» y «Chancho-va» colectivos de diseño tipográfico y divulgación. Algunos de sus diseños fueron seleccionados en la Bienal Latinoamericana «Tipos Latinos» y en la Bienal de Diseño FADU. «Ruda», tipografía publicada en Google Fonts recibió en 2023 la distinción del Sello Buen Diseño argentino y es utilizada actualmente en la identidad visual de la Escuela de Bellas Artes (ESAD) de Reims en Francia.",
    institucion: "UNLa, UBA, Argentina",
    contacto: "dsbladunla@gmail.com",
    foto: "angelina",
  ...
  {
    nombre: "Esp. Estefania Fondevila Sancet",
    cargo: "Arquitectura y programación web",
    bio: "Estefanía Fondevila Sancet, es Especialista en Metodología de la Investigación Científica UNLa, Diplomada en Ciencia y Tecnología UNQ y programadora web, Responsable de la coordinacion de Investigación del Departamento de Humanidades y Artes de la UNLa, fundadora del HUB de Diseño Industrial de la UNLa, desarrolla herramientas de planificación, diagnóstico, desarrollo y seguimiento de proyectos y emprendimientos. Articula con empresas, instituciones y equipos interdisciplinarios. Se desempeña como Directora de proyectos de investigación, de becarios y pasantes, con instituciones nacionales e internacionales. Actualmente su actividad docente se desarrolla en UNLa, como profesora adjunta concursada en la materia Ciencia aplicada al Diseño Industrial, Taller de Prácticas Preprofesionales y en Taller Integrador Final en la Licenciatura en Diseño Industrial. Participa de redes nacionales de Gestión de la Ciencia y la Tecnología. 1er premio innovar 2012 y 2016, Distinguida con Diploma de Honor en el concurso Arte, ciencia, tecnologia e innovación",
    institucion: "UNLa, Argentina",
    contacto: "dsbladunla@gmail.com",
    foto: "estefi",
  ...
  {
    nombre: "Ariadna Nabila Jaime Schröpfer",
    cargo: "Diseño y maquetación editorial",
    contacto: "dsblad.diseno@gmail.com",
    institucion: "UNLa, Argentina",
    foto: "jaime",
    bio: "Graduado de la ESEA Manuel Belgrano con Título de Bachiller en Artes Visuales con especialidad en producción artística contemporánea, y estudiante avanzado de la Licenciatura en Diseño y Comunicación Visual en la Universidad Nacional de Lanús, habiendo ejercido como auxiliar docente ad-honorem de las materias Medios Expresivos III e Introducción a la Expresión Visual asistiendo a los profesores Carlos Bisolino y Virginia Spinelli durante 2023 y 2024. Ilustrador, con enfoque en elaboración de obras digitales, e interés en abordar sus proyectos explorando la intersección entre el diseño gráfico y el arte visual. En la actualidad, diseñó el primer prototipo para la Revista DSB LAD y formó parte del equipo encargado de la maquetación editorial de la primera edición.",
  },
  {
    nombre: "Abril Marcela Costa",
    cargo: "Maquetación editorial",
    contacto: "dsblad.diseno@gmail.com",
    institucion: "UNLa, Argentina",
    foto: "abril",
    bio: "Es estudiante de cuarto año de la Licenciatura en Diseño y Comunicación Visual en la Universidad Nacional de Lanús. Su principal interés se centra en el diseño editorial, con especial atención al uso de la tipografía y la composición visual. Actualmente se desempeña como diseñadora freelance, desarrollando proyectos vinculados al ámbito gráfico.",
  },
  {
  ...
  },
  {
    ...
    institucion: "UNLa, Argentina",
    foto: "SolMartinez",
    bio: "Sol Camila Martinez es una estudiante avanzada de la Licenciatura en Diseño y Comunicación Visual en la Universidad Nacional de Lanús. Formándose paralelamente a la carrera en el área de diseño UX/UI. Con un interés especial por las artes plásticas y la exploración de distintas piezas gráficas. Partícipe en el proyecto Non Sapere organizado por Civic City, al marco del taller de diseño orientado, mediante la realización de piezas de diseño de la información en cuanto a problemáticas sociales. Siendo presentado en la exposición en la Écoles Estienne y el libro L’école du Non-savoir de Civic City. Actualmente forma parte del equipo de maquetación editorial en la primera edición de la revista DSB LAD.",
  },
  {
    nombre: "Agustina Aylen Quiroga",
    cargo: "Maquetación editorial",
    contacto: "dsblad.diseno@gmail.com",
    institucion: "UNLa, Argentina",
    bio: "Agustina Aylen Quiroga es estudiante del cuarto año de la Licenciatura en Diseño y Comunicación Visual en la Universidad Nacional de Lanús. Actualmente se encuentra como auxiliar docente ad-honorem en la materia Espacio Tipográfico II. También está participando en dos proyectos académicos formando parte del equipo editorial en la maquetación de la primera edición de la Revista DSB LAD, y coordinando el equipo de diseño del Encuentro Internacional de la Red de Cultura Gráfica en su segunda edición. Es apasionada por el diseño y de los procesos creativos. Sus principales hobbies son el dibujo y la pintura.",
    foto: "AgustinaAylenQuiroga",
  },
];

const renderMiembros = (contenedorId, array) => {
  const contenedor = document.getElementById(contenedorId);
  contenedor.innerHTML = "";
  array.forEach((m) => {
    contenedor.innerHTML += `
      <div class="miembro-equipo flex items-start p-4 gap-4">
        ...
        <div class="flex flex-col justify-center">
          ...
          <p class="text-sm font-light">${m.institucion || ""}</p>
          ${
            m.bio
              ? `<details>
...
renderMiembros("editora", editora);
renderMiembros("direccionDI", direccionDI);
renderMiembros("direccionDYCV", direccionDYCV);
renderMiembros("consejo-redaccion", miembrosConsejoRedaccion);
renderMiembros("comite-cientifico", miembrosComiteCientifico);
renderMiembros("equipo-diseno", miembrosDiseno);
